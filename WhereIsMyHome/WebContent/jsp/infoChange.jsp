...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-black">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <button id="btnNavLogout" class="btn btn-outline-success logout" data-bs-toggle="modal" data-bs-target="#logoutModal">Log Out</button>
          </div>
        </div>
      </nav>
    </div>
        ...
        <div class="login-page">
          ...
          <div class="form">
            <form name="register-form" class="register-form">
              ...
              <button id="btnChange" type="button">회원 수정</button>
              <button id="btnUnregist" type="button">회원 탈퇴</button>
            </form>
          </div>
        </div>
      </main>
    ...
    <script type="text/javascript" src="../js/infoChange.js"></script>
